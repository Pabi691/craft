      ...
      <div className="container-x grid gap-5 lg:grid-cols-2">
        ...
        <Reveal delay={0.1} className="relative overflow-hidden rounded-[2.25rem] bg-ink-950 p-8 text-paper md:p-12">
          ...
          <div className="relative flex h-full flex-col">
            ...
            <SplitText as="h3" text="Join us. Sip with us. | *Co-create* with us." className="h-display mt-5 text-4xl text-paper md:text-5xl" highlightClassName="italic text-gold-foil" />
