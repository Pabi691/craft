...
import { FiFeather, FiLayers, FiTag, FiTruck } from 'react-icons/fi';
import SectionHeading from '../ui/SectionHeading';
import { SITE } from '../../config/site';
import { EASE } from '../../lib/motion';

const ICONS = [FiFeather, FiLayers, FiTag, FiTruck];

export default function WhyUs() {
  return (
    <section className="bg-paper-200/60 py-24 md:py-32">
      <div className="container-x">
        <SectionHeading eyebrow="Why shop with us" title="Honest fabric. | Honest *craft.*" align="center" />
        <div className="mt-16 grid gap-px overflow-hidden rounded-[2rem] bg-ink-900/10 sm:grid-cols-2 lg:grid-cols-4">
          {SITE.whyShop.map((item, i) => {
            ...
            return (
              ...
              >
                <span className="absolute inset-x-0 top-0 h-1 origin-left scale-x-0 bg-brand-500 transition-transform duration-700 ease-silk group-hover:scale-x-100" />
